    ...
    <Container id='about'>
      <Card className="card shadow-sm">
        ...
        <CardHeader>
          ...
          <h1>Are you looking for your next Web developer or Software Engineer? Then you're in the right spot.</h1>

          <br />

          <h2>A passionate Full-Stack Developer with a focus in MERN.</h2>
        </CardHeader>
        <Card>
        <CardBody>
          <CardTitle> Hi! I'm Jaime Nickels,</CardTitle>
